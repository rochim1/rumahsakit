    ...
    <div class="container-fluid">
        <div class="row" id="vuetemp">
            <div class="col-md-8">
                            ...
                            <div class="form-row">
                                <div class="border p-3 form-row">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <select v-on:click="apiKota(2)" v-model="data_form.kota" class="form-control">
                            ...
                            <div class="form-row mt-2">
                                <div class="col-sm-12 d-flex flex-row-reverse">
                                    <button type="button" v-on:click="simpanpasien"
                                        class="btn ml-3 form-group btn-primary gradient-1">Daftar</button>
                                    <button type="reset" v-on:click="pemeriksaan(pemeriksaan.id_pasien)"
                                        class="ml-3 btn form-group btn-primary">Pemeriksaan</button>
                ...
                <div class="modal fade animate__animated animate__rubberBand " id="ModalAsuransi" data-backdrop="static"
                    tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="staticBackdropLabel">Pilih Asuransi / Pembayaran</h5>
                            </div>
                            <div class="modal-body">
                                <div class="d-flex flex-wrap">
                                    <div class="p-2 w-50 hvr-float-shadow">
                                        <div v-on:click="pilihAsuransi(1)" class="card bg-success">
                                            <div class="card-body">
                                                <h5 class="card-title text-center text-white">BPJS</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="p-2 w-50 hvr-float-shadow">
                                        <div v-on:click="pilihAsuransi(2)" class="card bg-primary">
                                            <div class="card-body">
                                                <h5 class="card-title text-center text-white">Pasien Umum</h5>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal fade animate__animated animate__rubberBand " id="ModalIdAsuransi"
                    data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="staticBackdropLabel">Masukan Nomor BPJS</h5>
                            </div>
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>nomor BPJS</label>
                                    <input id="noBPJS" v-model="data_form.idasuransi" type="number"
                                        class="form-control">
                                    <small id="errNoBPJS" class="invalid-tooltip collapse">masukkan nomor BPJS terlebih
                                        dahulu</small>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" v-on:click="svIdasuransi">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group ">
                            <label for="">asuransi / pembayaran</label>
                                                    ...
                                                    <div class="border p-3 form-row">
                                                        <div class="col-sm-6 form-group">
                                                            ...
                                                            <select class="form-control"
                                                                ...
                                                                <option value="">--Kelurahan--</option>
                                                                <option v-for="item in kelurahan_kel" :value="item.id">
                                                                    @{{item.nama}}</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 form-group">
                                                            ...
                                                            <select v-on:click="apiKota(2)"
                                                                v-model="infotambahan.kota_kel" class="form-control">
                                                                <option value="">--Kota--</option>
                        ...
                        <div class="list-group">
                            <span style="display: flex" class="row list-group-item list-group-item-action">
                                ...
                                <span class="col-md-4">
                                    ...
                                    <a href="javascript:;" v-on:click="tes">tes
                                    </a>
                                </span>
                            </span>
                        </div>
                ...
                <div class="modal-dialog " role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                    ...
                                    <form action="{{route('buatRM')}}" class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @foreach ($caramasuk as $index => $item)
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="inlineRadioOptions" id="inlineRadio{{$index+1}}"
                                                            value="{{$item->id}}">
                                                        <label class="form-check-label"
                                                            for="inlineRadio{{$index+1}}">{{$item->cara_masuk}}</label>
                                                    </div>
                                                    @endforeach
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-row">
                                                ...
                                                <div class="alert alert-warning alert-dismissible fade show">
                                                    Todo : seharusnya lebih baik menggunakan javascript untuk fungsi
                                                    tombol
                                                    "buat sekarang" karena untuk jam tidak realtime resiko pada saat
                                                    mendekati
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select v-model="periksa.dokter" v-on:click="tampildokter"
                                                    class="form-control" name="pemeriksaan_lab" id="lab_periksa">
                            ...
                            <div class="shadow card text-white" id="member-card">
                                ...
                                <div class="card-footer text-dark text-center">
                                    <small>mohon untuk menyimpan kartu ini baik-baik, dan selalu dibawa setiap
                                        kali melakukan pemeriksaan di
                                        rumah
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="javascript:void();" v-on:click="printCard"
                                class="btn btn-primary gradient-4">Print</a>
                            <a href="" class="btn btn-primary gradient-4">Advance</a>
                            <button v-on:click="buatRM" type="button" class="btn btn-primary gradient-1">Ok</button>
                        </div>
                    </div>
                </div>
...
<script>
    new Vue({
        ...
        methods: {
            tes: function () {
                alert("<?php  QrCode::size(100)->generate('aku sayang kamu'); ?>");
            ...
            pemeriksaan: function (id_pasien) {
                $("#Modalpemeriksaan").modal('show');
            },
            asuransi: function () {
                $('#ModalAsuransi').modal({
            ...
            pilihAsuransi: function (kat) {
                if (kat == 1) {
                    this.data_form.asuransi = 1;
                    $('#ModalIdAsuransi').modal({
                        show: true,
                        keyboard: false,
                        backdrop: 'static'
                    });
                } else {
                    this.data_form.asuransi = '';
                }
                $('#ModalAsuransi').modal('hide');
                this.asuransiCtrl();
            },
            svIdasuransi: function () {
                if (this.data_form.idasuransi) {
                    $('#ModalIdAsuransi').modal('hide');
                    $("#noBPJS").removeClass('is-invalid');
                    $("#errNoBPJS").hide();
                } else {
                    $("#noBPJS").addClass('is-invalid');
                    $("#noBPJS").focus();
                    $("#errNoBPJS").show();
                }
            },
            printCard: function () {
                var myDiv = document.getElementById('member-card').outerHTML;
                ...
                style.href = "{{asset('Componentadmin/css/style.css')}}";
                style.media = "all";

                style1.type = "text/css";
                style1.rel = "stylesheet";
                style1.href = "{{asset('Componentadmin/css/printcard.css')}}";
                style1.media = "all";
                newWindow.document.write("<html><body " +
                    ...
                    myDiv +
                    "</body></html>");
                newWindow.document.getElementsByTagName("head")[0].appendChild(style1);
