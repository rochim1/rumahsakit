...
@section('title',"home - Rs. Harapan Bersama")
@section('section')
...
<section class="hero-area">
    <div class="hero-slides owl-carousel">
        ...
        <div class="single-hero-slide bg-img bg-overlay-white"
            style="background-image: url({{asset('rs/img/bg-img/hero1.jpg')}});">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            <h2 data-animation="fadeInUp" data-delay="100ms">RS. Harapan Bersama <br>Care with Love</h2>
                            <h6 data-animation="fadeInUp" data-delay="400ms">jalan Mawar Melati KM.15, Bantul,
                                Yogyakarta, Pos 121513</h6>
                            <a href="#" class="btn medilife-btn mt-50" data-animation="fadeInUp" data-delay="700ms">Info
                                lebih lanjut<span>+</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Single Hero Slide -->
        <div class="single-hero-slide bg-img bg-overlay-white"
            style="background-image: url({{asset('rs/img/bg-img/breadcumb3.jpg')}});">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            <h2 data-animation="fadeInUp" data-delay="100ms">Dokter Spesialis <br>berbagai bidang</h2>
                            <h6 data-animation="fadeInUp" data-delay="400ms">spesialis anak, spesialis penyakit dalam,
                                spesialis saraf, spesialis bedah <a href="#">lainnya..</a> </h6>
                            <a href="#" class="btn medilife-btn mt-50" data-animation="fadeInUp"
                                data-delay="700ms">info lebih lanjut<span>+</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Single Hero Slide -->
        <div class="single-hero-slide bg-img bg-overlay-white"
            style="background-image: url({{asset('rs/img/bg-img/breadcumb1.jpg')}});">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <div class="hero-slides-content">
                            <h2 data-animation="fadeInUp" data-delay="100ms">perangkat medis<br>dengan teknologi cangih
                            </h2>
                            <h6 data-animation="fadeInUp" data-delay="400ms">Rs. Harapan Bersama menggunakan alat medis
                                canggih untuk mendukung kualitas dan efektifitas medis<h6>
                                    <a href="#" class="btn medilife-btn mt-50" data-animation="fadeInUp"
                                        data-delay="700ms">info lebih lanjut<span>+</span></a>
                        </div>
                    </div>
...
<div class="medilife-gallery-area owl-carousel">
    ...
    <div class="single-gallery-item">
        <img src="{{asset('rs/img/bg-img/g1.jpg')}}" alt="">
    ...
    <!-- Single Gallery Item -->
    <div class="single-gallery-item">
        <img src="{{asset('rs/img/bg-img/g2.jpg')}}" alt="">
        <div class="view-more-btn">
    ...
    <!-- Single Gallery Item -->
    <div class="single-gallery-item">
        <img src="{{asset('rs/img/bg-img/g3.jpg')}}" alt="">
        <div class="view-more-btn">
    ...
    <!-- Single Gallery Item -->
    <div class="single-gallery-item">
        <img src="{{asset('rs/img/bg-img/g4.jpg')}}" alt="">
        <div class="view-more-btn">
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6">
                <div class="features-content">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                        ut laoreet dolore magna aliquam erat volutpat. Lorem ipsum dolor sit amet, consectetuer
                        adipiscing eli.Lorem ipsum dolor sit amet, consec tetuer adipiscing elit, sed diam nonummy nibh
            ...
            <div class="col-12 col-lg-6">
                <div class="features-thumbnail">
                    <img src="{{asset('rs/img/bg-img/medical1.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-area mb-100">
                    ...
                    <div class="blog-post-thumbnail">
                        <img src="{{asset('rs/img/blog-img/1.jpg')}}" alt="">
                        <!-- Post Date -->
                        <div class="post-date">
                    ...
                    <div class="post-content">
                        <div class="post-author">
                            <a href="#"><img src="{{asset('rs/img/blog-img/p1.jpg')}}" alt=""></a>
                        </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-area mb-100">
                    <!-- Post Thumbnail -->
                    <div class="blog-post-thumbnail">
                        <img src="{{asset('rs/img/blog-img/2.jpg')}}" alt="">
                        <!-- Post Date -->
                        <div class="post-date">
                            <a href="#">Jan 23, 2018</a>
                        </div>
                    ...
                    <div class="post-content">
                        <div class="post-author">
                            <a href="#"><img src="{{asset('rs/img/blog-img/p2.jpg')}}" alt=""></a>
                        </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-area mb-100">
                    <!-- Post Thumbnail -->
                    <div class="blog-post-thumbnail">
                        <img src="{{asset('rs/img/blog-img/3.jpg')}}" alt="">
                        <!-- Post Date -->
                        <div class="post-date">
                            <a href="#">Jan 23, 2018</a>
                        </div>
                    ...
                    <div class="post-content">
                        <div class="post-author">
                            <a href="#"><img src="{{asset('rs/img/blog-img/p3.jpg')}}" alt=""></a>
                        </div>
