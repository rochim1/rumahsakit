...
@section('title', 'halaman sedang dalam maintenance')
@section('style')
    <style>
...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <img src="https://www.bibliocad.com/global/images/others/503.png" width="327" alt="Error 503" />
      <h1 class="message__title">Mainenance mode</h1>
